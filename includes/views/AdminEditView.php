...
class AdminEditView {
	...
	<div class="wrap">
		...
		<form id="hbedit" action="" method="POST">
			...
			<td><?php _e('NE')?> <input type="radio" name="bubble_tail_direction" value ="NE" <?php if ($bubble->getBubbleTailDirection() == "NE") echo 'checked' ; ?> />&nbsp </td>
			...
			<td><?php _e('SE')?> <input type="radio" name="bubble_tail_direction" value ="SE" <?php if ($bubble->getBubbleTailDirection() == "SE") echo 'checked' ; ?> /> &nbsp</td>
